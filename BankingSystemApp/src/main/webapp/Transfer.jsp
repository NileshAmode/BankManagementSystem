...
<body>
    ...
    <div class="footer">
        ...
        <div id="new">
         <%
               CustomerBean cb= (CustomerBean)application.getAttribute("sender");
              CustomerBean cb1= (CustomerBean)application.getAttribute("reciever");
               String msg = (String)request.getAttribute("msg");
            		...
            		{
            			long bal = (long)request.getAttribute("amount");
            			out.println(bal+ " Debited from "+ cb.getAccount()+ " and  Creadited  to " +cb1.getAccount()+ " on " + ld +"<br>");
            			out.println("Available  Balance is " + cb.getAmount());
            		}
            %>
